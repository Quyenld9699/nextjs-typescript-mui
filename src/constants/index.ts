...
export const TitlePage = 'Vottery';
export const DescriptionPage = 'VChain,  Decentralized application development and deployment platform on Blockchain technology on vchain.zone';
